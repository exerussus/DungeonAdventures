...
while x != 656:
    pyautogui.press('down', presses=6, interval=0.001)
    with pyautogui.hold('ctrl'):
        pyautogui.press('right', presses=5, interval=0.001)
    pyautogui.press(',', presses=1, interval=0.001)
    pyautogui.press('enter', presses=1, interval=0.001)
    pyautogui.press("'")
    pyautogui.press('i')
    pyautogui.press('n')
    pyautogui.press('s')
